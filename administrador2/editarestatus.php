...
$id_pedido = $_GET['id_pedido']; // Obtener el ID del pedido a editar
            ...
            table {
                ...
                <main>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="mt-4">Editar estatus</h1>
                        <a href="pedidos.php" onclick="history.back();" class="btn btn-danger"> X </a>
                    </div>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Modificar estatus del pedido:</li>
                        </ol>
                            ...
                            <div class="col-xl-8">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-footer d-flex align-items-start justify-content-between">
                                        <div class="d-flex ">
                                            <div>
                                            <img src="assets/img/pedido.png" alt="imagenUsuario" style="width: 100%; height: auto;">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input type="hidden" name="id_pedido" value="<?php echo $pedido['id_pedido']; ?>" />
                                                    ...
                                                    <tr>
                                                        <td>Monto Final:</td>
                                                        <td><?php echo $pedido['monto_final']; ?></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="Estatus" required>
                                                                <option value="Recibido" <?php if ($pedido['Estatus'] == 'Recibido') echo 'selected'; ?>>Recibido</option>
                                                                <option value="Preparando" <?php if ($pedido['Estatus'] == 'Preparando') echo 'selected'; ?>>Preparando</option>
                                                                <option value="Listo Para Entrega" <?php if ($pedido['Estatus'] == 'Listo Para Entrega') echo 'selected'; ?>>Listo Para Entrega</option>
