                                        ...
                                        <?php while($row=$result->fetch_assoc()) {?>
                                            ...
                                            if($id_cargo == 1 || $id_cargo==3){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="detalles.php?ref=<?php echo $row['ref']; ?>" class="btn btn-success" style="margin-right: 10px;">Ver detalles</a><a href="editarestatus.php?id_pedido=<?php echo $row['id_pedido']; ?>" class="btn btn-danger" >Editar Estatus</a> </td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
